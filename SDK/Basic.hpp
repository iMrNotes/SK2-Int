...
namespace Offsets
{
	constexpr int32 GObjects          = 0x08E2B1B0;
	constexpr int32 AppendString      = 0x02D42D60;
	constexpr int32 GNames            = 0x08D74D40;
	constexpr int32 GWorld            = 0x08CD9D90;
	constexpr int32 ProcessEvent      = 0x02EFA8A0;
